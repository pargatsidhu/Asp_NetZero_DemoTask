...
{
    public abstract class DemoTaskWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DemoTaskWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DemoTaskWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DemoTaskDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DemoTaskDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DemoTaskDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DemoTaskDbContext, Task<T>> func)
        {
            T result;
