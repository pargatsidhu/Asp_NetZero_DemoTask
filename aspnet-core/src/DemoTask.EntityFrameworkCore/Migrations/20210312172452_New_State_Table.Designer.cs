...
namespace DemoTask.Migrations
{
    ...
    [Migration("20210312172452_New_State_Table")]
    partial class New_State_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoTask.Country.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DemoTask.State.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DemoTask.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DemoTask.Authorization.Users.User", null)
                        .WithMany("Claims")
