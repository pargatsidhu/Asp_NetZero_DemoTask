...
export class CountryServiceProxy {
     ...
     * @return Success
     */
    getCountries(filter: string | null | undefined): Observable<CountryListDtoListResultDto> {
    ...
    protected processGetCountries(response: HttpResponseBase): Observable<CountryListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    editCountry(body: CountryDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Country/EditCountry";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processEditCountry(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class StateServiceProxy {
     ...
     * @return Success
     */
    getStates(filter: string | null | undefined): Observable<StateListDtoListResultDto> {
    ...
    protected processGetStates(response: HttpResponseBase): Observable<StateListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    editState(body: StateDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/State/EditState";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processEditState(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditState(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processEditState(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class GetCountryForEditOutput implements IGetCountryForEditOutput {
    ...
    init(_data?: any) {
        if (_data) {
            this.country = _data["country"] ? CountryEditDto.fromJS(_data["country"]) : <any>undefined;
        }
    }
...
export class StateListDto implements IStateListDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            this.descreption = _data["descreption"];
...
export class GetStateForEditOutput implements IGetStateForEditOutput {
    ...
    init(_data?: any) {
        if (_data) {
            this.state = _data["state"] ? StateEditDto.fromJS(_data["state"]) : <any>undefined;
        }
    }
